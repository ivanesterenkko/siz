...
async def add_issuance(
      warehouse_id: UUID4,
      issuance: AddWarehouse_itemRequest,
      customer: Suppliers = Depends(get_current_customer)
      ) -> None:
